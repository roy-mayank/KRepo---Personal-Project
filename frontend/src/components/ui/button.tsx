...
import type { ButtonProps as ButtonPrimitiveProps } from '@base-ui/react/button'
...
interface ButtonProps
  extends Omit<ButtonPrimitiveProps, 'className'>, VariantProps<typeof buttonVariants> {
  className?: string
}
